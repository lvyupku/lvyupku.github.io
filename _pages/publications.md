...
| Jie liu†, **Xin Cao†**, Pingchuan Zhang, Xueli Xu, Yangyang Liu, Guohua Geng, Fengjun Zhao, Kang Li, Mingquan Zhou. “[AMS-Net: An attention-based multi-scale network for classification of 3D Terracotta Warrior fragments](https://github.com/caoxin918/caoxin918.github.io/blob/master/files/remotesensing-2021.pdf)”, Remote Sensing. (2021) (equal contribution).  |
...
| **Xin Cao**, Kang Li, Xueli Xu, Karen M von Deneen, Guohua Geng, Xueli Chen. “Development of tomographic reconstruction for three-dimensional optical imaging: From the inversion of light propagation to artificial intelligence”, Artificial Intelligence in Medical Imaging (2020). |
