...
| |
| :---- |
|YI CHEN,MENGFEI DU, JUN ZHANG, GEGE ZHANGn, LINZHI SU,  KANG LI※, FENGJUN ZHAO, 1HUANGJIAN YI, LIN WANG and **Xin Cao※**. “[Generalized Conditional Gradient Method with Adaptive Regularization Parameters for Fluorescence Molecular Tomography]()”, Optics Express. (2023). |
...
| Mengfei Du, Yi Chen, Weitong Li, Linzhi Su※, Huangjian Yi, Fengjun Zhao, Kang Li, Lin Wang and **Xin Cao※**. “[MSCN-NET: Multi-Stage Cascade Neural Network based on attention mechanism for Cerenkov luminescence tomography](https://caoxin918.github.io/files/MSCN-NET.pdf)”, Journal of Applied Physics. (2022).  |
| Weitong Li, Mengfei Du, Yi Chen, Haolin Wang, Linzhi Su※, Huangjian Yi, Fengjun Zhao, Kang Li, Lin Wang and **Xin Cao※**. “[GCR-Net: 3D Graph Convolution-based Residual Network for Robust Reconstruction in Cerenkov Luminescence Tomography](https://caoxin918.github.io/files/GCR-Net.pdf)”, Journal of Innovative Optical Health Sciences. (2022).  |
...
| Linzhi Su, Qiaoyun Xie, Fengjun Zhao, **Xin Cao※**. “[Change Detection for Multi-Spectral Images Using Modified Semantic Segmentation Network](https://caoxin918.github.io/苏临之2022.pdf)”, Journal of Applied Remote Sensing. (2022).  |
